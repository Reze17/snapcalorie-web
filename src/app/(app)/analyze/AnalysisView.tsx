  ...
  return (
    <div className="flex flex-col gap-6 pb-4">
      {outcome.status === "failed" && (
        <div className="flex flex-col gap-2 rounded border border-white/20 p-4">
          ...
          <button
            ...
            onClick={handleRetry}
            disabled={isRetrying}
            className="w-fit rounded bg-white/10 px-4 py-2 text-sm hover:bg-white/20 disabled:opacity-60"
          >
      ...
      <div className="sticky bottom-0 rounded-lg border border-white/10 bg-[var(--background)] px-4 py-3">
